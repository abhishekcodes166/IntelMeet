              ...
              {messages.length === 0 ? (
                ...
                messages.map((msg, idx) => (
                  <div key={idx} className="rounded-lg bg-white/5 border border-white/8 p-3 hover:border-white/12 transition">
                    <p className="text-xs font-semibold text-[#A3E635]">{msg.userName}</p>
            ...
            <div className="p-4 border-t border-white/8">
              <form onSubmit={onSendMessage} className="flex gap-2">
                <input
                  ...
                  className="flex-1 px-3 py-2 rounded-lg bg-white/5 border border-white/8 text-sm focus:outline-none focus:border-white/20 focus:ring-1 focus:ring-[#A3E635]"
                />
                <button
                  type="submit"
                  className="p-2 rounded-lg bg-[#A3E635] text-[#09090B] hover:bg-[#9ACD2E] transition"
                >
        ...
        {activeTab === 'notes' && (
          <div className="p-4 h-full flex items-center justify-center">
            <div className="text-center">
              <Sparkles className="w-8 h-8 text-[#A3E635] mx-auto mb-2 opacity-50" />
